...
<tr>
    ...
    <option value="WA"><option value="WV"><option value="WI"><option value="WY">
		...
		<tr>
			<td>
				<div class="form-floating mb-3">
   		 <input list="open" class="form-control" name="open" value="${dogpark.open }" size="4" placeholder="0000">
		...
		<tr>
			<td>
				<div class="form-floating mb-3">
   		 <input list="open" class="form-control" name="open" value="${dogpark.close }" size="4" placeholder="0000">
